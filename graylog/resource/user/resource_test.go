...
`,
		Check: resource.ComposeTestCheckFunc(
			...
			resource.TestCheckResourceAttr("graylog_user.test", "first_name", "test"),
			resource.TestCheckResourceAttr("graylog_user.test", "last_name", "test"),
		),
	}
	...
	updateRoute := flute.Route{
		...
		Tester: flute.Tester{
			...
			Test: func(t *testing.T, req *http.Request, svc flute.Service, route flute.Route) {
				...
				require.Equal(t, "first updated", body["first_name"])
				require.Equal(t, "last updated", body["last_name"])
...
`,
		Check: resource.ComposeTestCheckFunc(
			...
			resource.TestCheckResourceAttr("graylog_user.test", "email", "test@example.com"),
			resource.TestCheckResourceAttr("graylog_user.test", "password", "password"),
			resource.TestCheckResourceAttr("graylog_user.test", "first_name", "first updated"),
			resource.TestCheckResourceAttr("graylog_user.test", "last_name", "last updated"),
		),
	}
